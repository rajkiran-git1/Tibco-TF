...
output "apps_subnets" {
  description = "List of IDs of apps subnets"
  value       = aws_subnet.apps.*.id
}

output "apps_subnet_arns" {
  description = "List of ARNs of apps subnets"
  value       = aws_subnet.apps.*.arn
}

output "apps_subnets_cidr_blocks" {
  description = "List of cidr_blocks of apps subnets"
  value       = aws_subnet.apps.*.cidr_block
}

output "apps_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of apps subnets in an IPv6 enabled VPC"
  value       = aws_subnet.apps.*.ipv6_cidr_block
}

output "ecodass_subnets" {
  description = "List of IDs of ecodass subnets"
  value       = aws_subnet.ecodass.*.id
}

output "ecodass_subnet_arns" {
  description = "List of ARNs of ecodass subnets"
  value       = aws_subnet.ecodass.*.arn
}

output "ecodass_subnets_cidr_blocks" {
  description = "List of cidr_blocks of ecodass subnets"
  value       = aws_subnet.ecodass.*.cidr_block
}

output "ecodass_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of ecodass subnets in an IPv6 enabled VPC"
  value       = aws_subnet.ecodass.*.ipv6_cidr_block
}
...
output "apps_route_table_ids" {
  description = "List of IDs of apps route tables"
  value       = length(aws_route_table.apps.*.id) > 0 ? aws_route_table.apps.*.id : aws_route_table.private.*.id
}

output "ecodass_route_table_ids" {
  description = "List of IDs of ecodass route tables"
  value       = length(aws_route_table.ecodass.*.id) > 0 ? aws_route_table.ecodass.*.id : aws_route_table.private.*.id
}
...
output "apps_network_acl_id" {
  description = "ID of the apps network ACL"
  value       = concat(aws_network_acl.apps.*.id, [""])[0]
}

output "ecodass_network_acl_id" {
  description = "ID of the ecodass network ACL"
  value       = concat(aws_network_acl.ecodass.*.id, [""])[0]
}
...
output "mgmt_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of mgmt subnets in an IPv6 enabled VPC"
  value       = aws_subnet.mgmt.*.ipv6_cidr_block
}

output "mgmt_route_table_ids" {
  description = "List of IDs of mgmt route tables"
  value       = length(aws_route_table.mgmt.*.id) > 0 ? aws_route_table.mgmt.*.id : aws_route_table.private.*.id
}

output "mgmt_network_acl_id" {
  description = "ID of the mgmt network ACL"
  value       = concat(aws_network_acl.mgmt.*.id, [""])[0]
}
